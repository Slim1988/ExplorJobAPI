...
namespace ExplorJobAPI.Migrations
{
    ...
    partial class ExplorJobDbContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("ExplorJobAPI.DAL.Entities.Messaging.Appointment.ReviewEntity", b =>
                {
                    ...
                    b.Property<int?>("IsExplorerGood")
                        .HasColumnType("integer");

                    b.Property<int?>("IsExplorerInterestingForCompany")
                        .HasColumnType("integer");

                    b.Property<Guid?>("JobUserEntityId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ExplorJobAPI.DAL.Entities.Messaging.Appointment.ReviewEntity", b =>
                {
                    ...
                    b.HasOne("ExplorJobAPI.DAL.Entities.Jobs.JobUserEntity", null)
                        .WithMany("Reviews")
                        .HasForeignKey("JobUserEntityId");
